...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#090d16] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-indigo-600/20 rounded-full blur-3xl animate-pulse-glow" />
      <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: '2s' }} />
      ...
      <div className="w-full max-w-md z-10 animate-fade-in">
        ...
        <div className="glass-panel p-8 rounded-3xl border border-white/10 shadow-2xl">
          ...
          <p className="text-xs text-slate-400 mb-6">Sign in to access your personal command center</p>
